...
exports.trackOrder = exports.requestRefund = exports.cancelOrder = exports.updateOrderStatus = exports.getOrderDetails = exports.getBuyerOrders = exports.createOrder = void 0;
...
const createOrder = async (req, res) => {
    try {
        ...
        const { productId, quantity = 1, shippingAddress, paymentMethod, deliveryOption = 'standard' } = req.body;
        // Get product details
...
const trackOrder = async (req, res) => {
    try {
        ...
        res.json({
            ...
            trackingEvents: trackingEvents.sort((a, b) => new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime())
        });
    }
    catch (error) {
...
async function createShipmentForOrder(orderId, shippingAddress) {
    try {
        const order = await prisma.order.findUnique({
            where: { id: orderId },
