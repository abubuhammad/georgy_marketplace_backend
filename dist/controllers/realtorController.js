...
exports.getMarketInsights = exports.getClients = exports.updateProfile = exports.getProfile = exports.getAnalytics = exports.updateViewingStatus = exports.scheduleViewing = exports.getViewings = exports.bulkUpdateProperties = exports.deleteProperty = exports.updateProperty = exports.createProperty = exports.getProperties = exports.getDashboardStats = void 0;
...
const getProperties = async (req, res) => {
    try {
        const realtorId = req.user?.id;
        const { page = 1, limit = 20, status, type, propertyType, search, minPrice, maxPrice, sortBy = 'createdAt', sortOrder = 'desc' } = req.query;
        const where = {
            ownerId: realtorId
        };
...
const createProperty = async (req, res) => {
    try {
        const realtorId = req.user?.id;
        const { title, description, type, propertyType, price, bedrooms, bathrooms, area, location, address, latitude, longitude, images = [], virtualTour, amenities = [], featured = false } = req.body;
...
exports.getViewings = getViewings;
const scheduleViewing = async (req, res) => {
    try {
        const realtorId = req.user?.id;
        const { propertyId, viewerId, scheduledAt, notes } = req.body;
...
exports.updateViewingStatus = updateViewingStatus;
// Analytics
...
const updateProfile = async (req, res) => {
    try {
        const realtorId = req.user?.id;
        const { firstName, lastName, phone, avatar, bio, website, location, specialization, licenseNumber, experience, languages, serviceAreas } = req.body;
...
//# sourceMappingURL=realtorController.js.map