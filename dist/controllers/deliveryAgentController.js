...
exports.getPerformanceMetrics = exports.toggleAvailability = exports.updateLocation = exports.updateProfile = exports.getProfile = exports.getEarnings = exports.getOptimizedRoute = exports.updateShipmentStatus = exports.getAssignedShipments = exports.getDashboardStats = void 0;
...
exports.getAssignedShipments = getAssignedShipments;
...
const getOptimizedRoute = async (req, res) => {
    try {
        ...
        const totalEarnings = optimizedRoute.reduce((sum, shipment) => sum + (shipment.deliveryFee * 0.8), 0);
        res.json({
...
const updateProfile = async (req, res) => {
    try {
        const agentId = req.user?.id;
        const { firstName, lastName, phone, avatar, vehicleType, licensePlate, licenseNumber, emergencyContact, bankDetails, isAvailable } = req.body;
...
const getPerformanceMetrics = async (req, res) => {
    ...
    `;
        ...
        const onTimeData = onTimeDeliveries[0];
